...
outputDir <- "C:/Users/koush/Desktop/Koush/Projects/Workshops/Single Cell RNASeq HandsOn Workshop/GSE181919_HNSCC/output"
plotDir   <- "C:/Users/koush/Desktop/Koush/Projects/Workshops/Single Cell RNASeq HandsOn Workshop/GSE181919_HNSCC/plots"
study_id  <- "GSE181919"
```
...
```{r load_seurat}
seurat_combined <- readRDS(file = paste0("C:/Users/koush/Desktop/Koush/Projects/Workshops/Single Cell RNASeq HandsOn Workshop/GSE181919_HNSCC/output/01_GSE181919_seurat_raw.rds"))
...
```{r annotation_umaps}
# Load Harmony object
harmony_processed <- readRDS(paste0("C:/Users/koush/Desktop/Koush/Projects/Workshops/Single Cell RNASeq HandsOn Workshop/GSE181919_HNSCC/output04_GSE181919_harmony_corrected.rds"))
